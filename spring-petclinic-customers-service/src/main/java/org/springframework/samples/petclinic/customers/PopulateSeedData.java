...
public class PopulateSeedData {
    ...
    public void populateSeedData() {
        ...
        final Owner owner1 = new Owner(1, "George", "Franklin", "110 W. Liberty St.", "Madison", "6085551023", new HashSet<Integer>() {{
            add(1);
        }});
        final Owner owner2 = new Owner(2, "Betty", "Davis", "638 Cardinal Ave.", "Sun Prairie", "6085551749", new HashSet<Integer>() {{
            add(2);
        }});
        final Owner owner3 = new Owner(3, "Eduardo", "Rodriquez", "2693 Commerce St.", "McFarland", "6085558763", new HashSet<Integer>() {{
            add(3);
            add(4);
        }});
        final Owner owner4 = new Owner(4, "Harold", "Davis", "563 Friendly St.", "Windsor", "6085553198", new HashSet<Integer>() {{
            add(5);
        }});
        final Owner owner5 = new Owner(5, "Peter", "McTavish", "2387 S. Fair Way", "Madison", "6085552765", new HashSet<Integer>() {{
            add(6);
        }});
        final Owner owner6 = new Owner(6, "Jean", "Coleman", "105 N. Lake St.", "Monona", "6085552654", new HashSet<Integer>() {{
            add(7);
            add(8);
        }});
        final Owner owner7 = new Owner(7, "Jeff", "Black", "1450 Oak Blvd.", "Monona", "6085555387", new HashSet<Integer>() {{
            add(9);
        }});
        final Owner owner8 = new Owner(8, "Maria", "Escobito", "345 Maple St.", "Madison", "6085557683", new HashSet<Integer>() {{
            add(10);
        }});
        final Owner owner9 = new Owner(9, "David", "Schroeder", "2749 Blackhawk Trail", "Madison", "6085559435", new HashSet<Integer>() {{
            add(11);
        }});
        final Owner owner10 = new Owner(10, "Carlos", "Estaban", "2335 Independence La.", "Waunakee", "6085555487", new HashSet<Integer>() {{
            add(12);
            add(13);
        }});
