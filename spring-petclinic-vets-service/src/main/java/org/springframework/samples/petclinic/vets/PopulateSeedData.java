...
public class PopulateSeedData {
    ...
    public void populateSeedData() throws ParseException {
        ...
        final Vet vet2 = new Vet(2, "Helen", "Leary", new HashSet<Specialty>() {{
            add(speciality1);
        }});
        final Vet vet3 = new Vet(3, "Linda", "Douglas", new HashSet<Specialty>() {{
            add(speciality2);
            add(speciality3);
        }});
        final Vet vet4 = new Vet(4, "Rafael", "Ortega", new HashSet<Specialty>() {{
            add(speciality2);
        }});
        final Vet vet5 = new Vet(5, "Henry", "Stevens", new HashSet<Specialty>() {{
            add(speciality1);
        }});
